...
## Project Structure
    ...
    ├── sparkling_recipe_de_91536  # Django project configurations
...
1. Clone this repo and `cd sparkling_recipe_de_91536`
...
2. Clone this repo and `cd sparkling_recipe_de_91536`
